pub fn verse(n: u32) -> String {
    let (quantity, modifier, left) = match n {
        0 => ("no more".to_string(), "s".to_string(), "99 bottles".to_string()),
        1 => ("1".to_string(), "".to_string(), "no more bottles".to_string()),
        2 => ("2".to_string(), "s".to_string(), "1 bottle".to_string()),
        n => (n.to_string(), "s".to_string(), format!("{} bottles", (n - 1).to_string())),
    };
    ...
    let mut s = format!("{} bottle{} of beer on the wall, {} bottle{} of beer.\n{}, {} of beer on the wall.\n", quantity, modifier, quantity, modifier, middle, left);
